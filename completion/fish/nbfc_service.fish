...
complete -c nbfc_service -s c -l config-file -d 'Use alternative config file (default /etc/nbfc/nbfc.json)' -r -F
complete -c nbfc_service -s s -l state-file -d 'Write state to an alternative file (default /var/run/nbfc_service.state.json)' -r -F
